...
public class AndroidFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view=inflater.inflate(R.layout.fragment_net1414080903220_dev_article,container,false);
    ...
    private void requestData() {
        params.put("total","10");
        params.put("now",num);
        okHttpHelper.get(KnowAPIManager.GANK,KnowAPIManager.API.GANK_ANDROID_URL,params,new ResponseCallback<DevBaseBean>(getContext()) {
            @Override
        ...
        switch (state) {
            case STATE_NORMAL:
                if(devAdapter==null){
                    ...
                    devRv.setLayoutManager(new LinearLayoutManager(AndroidFragment.this.getActivity()));
                }else{

...
public class WebFragment extends Fragment {
    ...
    private void requestData() {
        params.put("total","10");
        params.put("now",num);
        okHttpHelper.get(KnowAPIManager.GANK,KnowAPIManager.API.GANK_WEB_URL,params,new ResponseCallback<DevBaseBean>(getContext()) {
            @Override
        ...
        switch (state) {
            case STATE_NORMAL:
                if (devAdapter == null) {
                    ...
                    devRv.setLayoutManager(new LinearLayoutManager(WebFragment.this.getActivity()));
                } else {

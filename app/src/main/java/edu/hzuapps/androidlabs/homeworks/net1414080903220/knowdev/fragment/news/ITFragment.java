...
public class ITFragment extends Fragment {
    ...
    public void requestData(){
        ...
        params.put("num",num);
        Log.i(TAG,""+params);
        okHttpHelper.get(KnowAPIManager.TIANXIN,KnowAPIManager.API.TX_IT_URL,params, new ResponseCallback<NewsBaseBean>(getContext()){
        ...
        switch (state) {
            case STATE_NORMAL:
                if (newsAdapter == null) {
                    ...
                    newsItemRV.setLayoutManager(new LinearLayoutManager(ITFragment.this.getActivity()));
                } else {

   ...
   //自定义的get方法
    ...
    public void request(final Request request,final BaseCallback callBack){
        ...
        public void onFailure(Request request, IOException e) {
            requestFailure(callBack,request,e);
            //callBack.onFailure(callBack,request,e);
        }
    ...
    private void requestFailure(final BaseCallback callBack,final Request request, final Exception e ){
        handler.post(new Runnable() {
            @Override
            public void run() {

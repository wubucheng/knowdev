...
public class IOSFragment extends Fragment {
    ...
    private void requestData() {
        params.put("total","10");
        params.put("now",num);
        okHttpHelper.get(KnowAPIManager.GANK,KnowAPIManager.API.GANK_IOS_URL,params,new ResponseCallback<DevBaseBean>(getContext()) {
            @Override
        ...
        switch (state) {
            case STATE_NORMAL:
                if (devAdapter == null) {
                    ...
                    devRv.setLayoutManager(new LinearLayoutManager(IOSFragment.this.getActivity()));
                } else {
